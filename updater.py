...
# آدرس Worker مانیفست بروزرسانی. روی نسخه‌ی VPS به‌صورت پیش‌فرض «خاموش» است
# تا بروزرسانی خودکار نتواند نسخه‌ی محلی را با نسخه‌ی ناسازگار جایگزین کند.
# اگر مانیفست بروزرسانی خودتان را دارید، با متغیر محیطی UPDATE_MANIFEST_URL ست کنید.
